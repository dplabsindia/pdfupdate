...
public class AddBookmarkForExistingPDF {

	public static void main(String[] args) {
		try (PDDocument document = PDDocument.load(new File("C:/Users/DELL/workspace_24092019/pdf_update/BookmarksPDF.pdf"))) {
			...
			document.save("C:/Users/DELL/workspace_24092019/pdf_update/ADDED_BookmarksPDF.pdf");
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
